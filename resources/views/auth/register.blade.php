        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register')}}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" placeholder="Your email address" class="bg-gray-100 border-2 w-full p-4 rounded-lg
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Password again" class="bg-gray-100 border-2 w-full p-4 rounded-lg
